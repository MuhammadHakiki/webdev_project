...
<div id="header" class="navbar smart-scroll navbar-fixed-top">
  ...
  <?php 
           $fetchall2 = "SELECT * FROM brooch where id='$nama1'";
...
<input type="hidden" name="images" value="<?php echo $gambar1?>">
                        ...
                        <div class="action">
                            <input type="submit" class="title" name="cart3" value="add to cart">  
                            <input type="submit" class="title" name="book3" value="Booking">                       
        ...
        <div class="col-sm-2">
            ...
            <div class="product-grid">
                ...
                <div class="product-image">
                    ...
                    <h3 class="title1"><a href="userDetailBrooch.php?id= <?php echo $id2 ?>"> <?php echo $names ?></a></h3>
