...
$email = $gender = '';
$sqli = "SELECT * FROM user WHERE name='$id1'";
...
if(isset($_POST['cart4'])) 
        ...
        if(isset($_SESSION["shopping_cart"]))
        {
            ...
            if(!in_array($_GET["id"], $item_array_id))
            {
                ...
                $_SESSION["shopping_cart"][$count] = $item_array;
                                ...
                                echo '<script>window.location="userDetailDress.php"</script>';
    ...
    $num = "SELECT COUNT(namaP) as total FROM cart where idP='$id1'";
    ...
    $num = "SELECT COUNT(namaB) as totalB FROM booking where idB='$id1'";
    $count = mysqli_query($conn, $num);
    $value = mysqli_fetch_assoc($count);
    $rowsB = $value['totalB'];
...
<div id="header" class="navbar smart-scroll navbar-fixed-top">
  ...
  <?php 
           $fetchall2 = "SELECT * FROM pijamas where id='$nama1'";
		...
		<div class="card">
          ...
          <div class="preview-pic tab-content">
                    ...
                    <form method="POST" action="userHome.php?dress = <?php echo $id2 ?>">
...
<input type="hidden" name="images" value="<?php echo $gambar1?>">
                        ...
                        <div class="action">
                            <input type="submit" class="title" name="cart4" value="add to cart">  
                            <input type="submit" class="title" name="book4" value="Booking">                       
        ...
        <div class="col-sm-2">
            ...
            <div class="product-grid">
                ...
                <div class="product-image">
                    ...
                    <h3 class="title1"><a href="userDetailPijamas.php?id= <?php echo $id2 ?>"> <?php echo $names ?></a></h3>
  ...
  .container1 {            
    ...
    .product-new-label {
        bcolor:#fff;background-color:#ef5777;font-size:30px;text-transform:uppercase;padding:12px 10px;display:block;color: white;
    }
