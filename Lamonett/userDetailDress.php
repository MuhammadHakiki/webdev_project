...
<input type="hidden" name="images" value="<?php echo $gambar1?>">
                        ...
                        <div class="action">
                            <input type="submit" class="title" name="cart" value="add to cart">  
                            <input type="submit" class="title" name="book" value="Booking">                       
        ...
        <div class="col-sm-2">
            ...
            <div class="product-grid">
                ...
                <div class="product-image">
                    ...
                    <h3 class="title1"><a href="userDetailDress.php?id= <?php echo $id2 ?>"> <?php echo $names ?></a></h3>
