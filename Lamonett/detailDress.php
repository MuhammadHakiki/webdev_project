<?php
    ...
    if(isset($_POST['cart'])) 
    {
        if(isset($_SESSION["shopping_cart"]))
        {
            ...
            if(!in_array($_GET["dress"], $item_array_id))
            {
                $count = count($_SESSION["shopping_id"]);
                $item_array = array(
                    'id'        => $_GET['id'],
                    'namaP'     => $_POST['nama'],
                    'descP'     => $_POST['deskripsi'],
                    'hargaP'    => $_POST['harga'],
                    'ukuranP'     => $_POST['ukuran'],
            ...
            else
            {
                ...
                echo '<script>window.location="dress.php"</script>';
            }
        } 
        else
        {
...
<div id="header" class="navbar smart-scroll navbar-fixed-top">
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="nav navbar-nav navbar-center" id="imgs" href="#">
          ...
          <div class="collapse navbar-collapse" id="myNavbar">
            <a id="menu-toggle" href="#" class="btn btn-lg btn-lg toggle"><i class="glyphicon glyphicon-user" style="color: #6A1C11;"><span class="A"> Login / Register </span></i> </a>
      ...
      <a class="nav navbar-nav navbar-right" id="imgs" href="#">
        <a id="navbar-brand1" href="userOrder.php? nama = <?php echo $_SESSION['gender'] ?>">Cart <span class="label" style="background-color: #6A1C11;">1</span></a></li> </a>
  ...
  <?php 
           $fetchall2 = "SELECT * FROM blouse where id='$nama1'";
		...
		<div class="card">
          ...
          <div class="preview-pic tab-content">
						...
						<ul class="preview-thumbnail nav nav-tabs">
						  <li class="active"><a data-target="#pic-1" data-toggle="tab"><?php echo "<img src='images/" .$gambar1."'>"; ?></a></li>
						</ul>
						
					</div>
					<div class="details col-md-5" id="pre">
          <form method="POST" action="home.php?myDress=<?php echo $_SESSION['myDress']  ?>">
            <input type="hidden" name="nama" value="<?php echo $names ?>">
            <input type="hidden" name="deskripsi" value="<?php echo $desc?>">
            <input type="hidden" name="harga" value="<?php echo $harga?>">
            <input type="hidden" name="ukuran" value="<?php echo $before?>">
            <input type="hidden" name="images" value="<?php echo $gambar1?>">
            ...
            <?php
              ...
              <div class="action">
                        <h3 class="title"><a href="login.php"> Login / Register </a></h3>
                        </div>
						</h5>
					</div>
				</div>
  ...
  <center>
      <div class="tribal1">
      <img src="images/Screen Shot 1442-06-25 at 17.09.14.png" width="350" />
      </div>
    <br>
    <br>
        ...
        <div class="col-sm-2">
            ...
            <div class="product-grid">
                ...
                <div class="product-image">
                    ...
                    <h3 class="title1"><a href="detailDress.php?dress= <?php echo $id2 ?>"> <?php echo $names ?></a></h3>
...
.product-grid .title1{font-size:13px;font-weight:400;letter-spacing:.5px;text-transform:capitalize;margin:0 0 10px;transition:all .3s ease 0s}
