...
<link rel="preconnect" href="https://fonts.gstatic.com">
<link href="https://fonts.googleapis.com/css2?family=Architects+Daughter&family=Indie+Flower&family=Kaushan+Script&display=swap" rel="stylesheet">
<script>
...
<body>
    ...
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="nav navbar-nav navbar-center" id="imgs" href="#">
          <img src="images/WhatsApp Image 2021-01-29 at 18.23.02.jpeg" width="220" /> </a>
          <br>
          <br>
      ...
      <a class="nav navbar-nav navbar-right" id="imgs" href="#">
        <a id="navbar-brand1" href="userOrder.php? nama = <?php echo $_SESSION['gender'] ?>"></a></li> </a>
  ...
  <br>
    ...
    <center>
      <div class="triball">
        <img src="images/th (5).jpeg" width="300" />
    </center>
    <br>
    <br>
    <br>
        ...
        <div class="col-sm-4">
            <div class="product-grid">
                <div class="product-image">
                    <a href="#">
                      <img class="pic-1" src='images/tshirt_hipster_1513966351_1f447748.jpg'>
                    </a>
                </div>
        ...
        <div class="col-sm-4">
          <div class="product-grid">
              <div class="product-image">
                  <a href="#">
                    <img class="pic-1" src='images/tshirt_hipster_1513966351_1f447748.jpg'>
                    <h3 class="title"><a href="adminblouse.php"> Upload </a></h3>
                  </a>
              </div>
              <div class="product-content">
              </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="product-grid">
                <div class="product-image">
                    <a href="#">
                      <img class="pic-1" src='images/rtr-2916-dbl (1).JPG'>
                    </a>
                </div>
                <div class="product-content">
                </div>
        ...
        <div class="col-sm-4">
          <div class="product-grid">
              <div class="product-image">
                  <a href="#">
                    <img class="pic-1" src='images/rtr-2916-dbl (1).JPG'>
                    <h3 class="title"><a href="adminSkirt.php"> Upload </a></h3>
                  </a>
              </div>
              <div class="product-content">
              </div>
    ...
    <div class="row"> 
        <div class="col-sm-4">
            <div class="product-grid">
                <div class="product-image">
                    <a href="#">
                      <img class="pic-1" src='images/WhatsApp Image 2021-01-31 at 23.56.29 (1).jpeg'>
                    </a>
                </div>
                <div class="product-content">
                </div>
        ...
        <div class="col-sm-4">
          <div class="product-grid">
              <div class="product-image">
                  <a href="#">
                    <img class="pic-1" src='images/WhatsApp Image 2021-01-31 at 23.56.29.jpeg'>
                    <h3 class="title"><a href="adminDress.php"> Upload </a></h3>
                  </a>
              </div>
              <div class="product-content">
              </div>
      ...
      <div class="col-sm-4">
        <div class="product-grid">
            <div class="product-image">
                <a href="#">
                  <img class="pic-1" src='images/WhatsApp Image 2021-01-31 at 23.56.30 (1).jpeg'>
                </a>
            </div>
            <div class="product-content">
            </div>
...
<br>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="product-grid">
                <div class="product-image">
                    <a href="#">
                      <img class="pic-1" src='images/WhatsApp Image 2021-01-31 at 23.56.10.jpeg'>
                    </a>
                </div>
                <div class="product-content">
                </div>
        ...
        <div class="col-sm-4">
          <div class="product-grid">
              <div class="product-image">
                  <a href="#">
                    <img class="pic-1" src='images/WhatsApp Image 2021-01-31 at 23.56.11.jpeg'>
                    <h3 class="title"><a href="adminAcc.php"> Upload </a></h3>
                  </a>
              </div>
              <div class="product-content">
              </div>
        ...
        <div class="col-sm-4">
          <div class="product-grid">
              <div class="product-image">
                  <a href="#">
                    <img class="pic-1" src='images/WhatsApp Image 2021-01-31 at 23.56.11.jpeg'>
                    <h3 class="title"><a href="adminHome.php"> Upload </a></h3>
                  </a>
              </div>
              <div class="product-content">
              </div>
    ...
    <center>
      <div class="tribal3">
        Copyright @ 2021 Lamonett. All Rights Reserved
      </div>
    </center>
    <br>
    <br>
...
.product-grid .product-content{background-color:white;text-align:center;padding:12px 0;margin:0 auto;position:absolute;left:0;right:0;bottom:-27px;z-index:1;transition:all .3s}
.product-grid:hover .product-content{bottom:0}
.product-grid .title{position: absolute;
  top: 75%;
  left: 50%;
...
.product-grid .title a:hover,.product-grid:hover .title a{color:black; }
