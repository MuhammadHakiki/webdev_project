<?php
    ...
    if(isset($_POST["cart"])) 
    {
        $namaP = $_POST['nama'];
        $hargaP = $_POST['harga'];
        $imagesP = $_POST['images'];
        $statusP = "Sold Out";


        $sql = "INSERT INTO cart (idP,namaP,hargaP,imagesP, buy) VALUES ('$id', '$namaP', '$hargaP', '$imagesP', '$statusP')";
                $result1 = mysqli_query($conn, $sql);
        $sqla = "UPDATE blouse SET tersedia='$statusP' WHERE id='$id1'";
                $result12 = mysqli_query($conn, $sqla);
    }
    ...
    if(isset($_POST["book"])) 
    {
        $namaB = $_POST['nama'];
        $hargaB = $_POST['harga'];
        $imagesB = $_POST['images'];
        $status = "Booked";


        $sqlb = "INSERT INTO booking (idB,namaB,hargaB,imagesB, status) VALUES ('$id', '$namaB', '$hargaB', '$imagesB', '$status')";
                $result1 = mysqli_query($conn, $sqlb);
        $sqlbs = "UPDATE blouse SET tersedia='$status' WHERE id='$id1'";
                $result12 = mysqli_query($conn, $sqlbs);
    ...
    if(isset($_POST["cart1"])) 
    {
        ...
        $sql = "INSERT INTO cart (idP,namaP,hargaP,imagesP, buy) VALUES ('$id', '$namaP', '$hargaP', '$imagesP', '$statusP')";
                $result1 = mysqli_query($conn, $sql);
        $sqla = "UPDATE skirt SET tersedia='$statusP' WHERE id='$id1'";
                $result12 = mysqli_query($conn, $sqla);
    }
    ...
    if(isset($_POST["book1"])) 
    {
        ...
        $sqlb = "INSERT INTO booking (idB,namaB,hargaB,imagesB, status) VALUES ('$id', '$namaB', '$hargaB', '$imagesB', '$status')";
                $result1 = mysqli_query($conn, $sqlb);
        $sqlbs = "UPDATE skirt SET tersedia='$status' WHERE id='$id1'";
                $result12 = mysqli_query($conn, $sqlbs);
    ...
    if(isset($_POST["cart2"])) 
    {
        ...
        $sql = "INSERT INTO cart (idP,namaP,hargaP,imagesP, buy) VALUES ('$id', '$namaP', '$hargaP', '$imagesP', '$statusP')";
                $result1 = mysqli_query($conn, $sql);
        $sqla = "UPDATE bottom SET tersedia='$statusP' WHERE id='$id1'";
                $result12 = mysqli_query($conn, $sqla);
    }
    ...
    if(isset($_POST["book2"])) 
    {
        ...
        $sqlb = "INSERT INTO booking (idB,namaB,hargaB,imagesB, status) VALUES ('$id', '$namaB', '$hargaB', '$imagesB', '$status')";
                $result1 = mysqli_query($conn, $sqlb);
        $sqlbs = "UPDATE bottom SET tersedia='$status' WHERE id='$id1'";
                $result12 = mysqli_query($conn, $sqlbs);
    ...
    if(isset($_POST["cart3"])) 
    {
        ...
        $sql = "INSERT INTO cart (idP,namaP,hargaP,imagesP, buy) VALUES ('$id', '$namaP', '$hargaP', '$imagesP', '$statusP')";
                $result1 = mysqli_query($conn, $sql);
        $sqla = "UPDATE brooch SET tersedia='$statusP' WHERE id='$id1'";
                $result12 = mysqli_query($conn, $sqla);
    }
    ...
    if(isset($_POST["book3"])) 
    {
        ...
        $sqlb = "INSERT INTO booking (idB,namaB,hargaB,imagesB, status) VALUES ('$id', '$namaB', '$hargaB', '$imagesB', '$status')";
                $result1 = mysqli_query($conn, $sqlb);
        $sqlbs = "UPDATE brooch SET tersedia='$status' WHERE id='$id1'";
                $result12 = mysqli_query($conn, $sqlbs);
    ...
    if(isset($_POST["cart4"])) 
    {
        ...
        $sql = "INSERT INTO cart (idP,namaP,hargaP,imagesP, buy) VALUES ('$id', '$namaP', '$hargaP', '$imagesP', '$statusP')";
                $result1 = mysqli_query($conn, $sql);
        $sqla = "UPDATE pijamas SET tersedia='$statusP' WHERE id='$id1'";
                $result12 = mysqli_query($conn, $sqla);
    }
    ...
    if(isset($_POST["book4"])) 
    {
        ...
        $sqlb = "INSERT INTO booking (idB,namaB,hargaB,imagesB, status) VALUES ('$id', '$namaB', '$hargaB', '$imagesB', '$status')";
                $result1 = mysqli_query($conn, $sqlb);
        $sqlbs = "UPDATE pijamas SET tersedia='$status' WHERE id='$id1'";
                $result12 = mysqli_query($conn, $sqlbs);

    }
    $fetch2 = "SELECT * FROM cart where idP='$id'";
        $result3 = mysqli_query($conn, $fetch2);
    $num = "SELECT COUNT(namaP) as total FROM cart where idP='$id'";
    $count = mysqli_query($conn, $num);
    $value = mysqli_fetch_assoc($count);
    $rows = $value['total'];

    $fetch2 = "SELECT * FROM booking where idB='$id'";
        $result3 = mysqli_query($conn, $fetch2);
    $num = "SELECT COUNT(namaB) as totalB FROM booking where idB='$id'";
    $count = mysqli_query($conn, $num);
    $value = mysqli_fetch_assoc($count);
    $rowsB = $value['totalB'];

    $email = $gender = '';
$sqli = "SELECT * FROM user WHERE name='$id'";
...
<body>
        ...
        <a class="nav navbar-nav navbar-center" id="imgs" href="#">
          ...
          <div class="collapse navbar-collapse" id="myNavbar">
            ...
            <ul class="nav navbar-nav navbar-center" id="imgs1"> 
                ...
                <li><a id="usr" href="#">HOME</a></li>
                <li><a id="usr" href="#">ABOUT US</a></li>
                <li><a id="usr" href="#">INSTAGRAM</a></li> 
                <li><a id="usr" href="home.php">LOG OUT</a></li>

                <li><a id="navbar-brand2" href="userBook.php? nama = <?php echo $_SESSION['gender'] ?>">Booked <span class="label label-danger", style="background-color:#6A1C11;"> <?php echo $rowsB ?> </span></a></li> </a>
</li>         
  ...
  <div class="jumbotron jumbotron-fluid" id="sec">
    <div class="container">
      
      <h1 class="display-4">HOT <span>PROMO</span>
        <br>
        <center>
          <a href="rok.php">
            <button type="button" id="btn1" class="btn btn-lg">Primary</button>
        </a>
        </center>
    </div>
  </div>
  <br>
    ...
    <div class="row">
      <div class="col-sm-7" style="background-color:white;">
        <center>
          <div class="hh">
            La Monett is a sustainable clothing brand born from the need to create beautiful things that will last for years.
    ...
    <center>
      <div class="tribal1">
      <img src="images/arrival.png" width="350" />
      </div>
    </center>
    <div class="hh1">
      <p>
    ...
    <div class="row">
        <?php 
           $fetchall = "SELECT * FROM blouse where id LIMIT 6";
        ...
        <div class="col-sm-2">
            ...
            <div class="product-grid">
                <center>
                <div class="product-new-label">NEW ARRIVAL!!!</div>
                ...
                <div class="product-image">
                    ...
                    <h3 class="title"><a href="userDetailNew.php?id= <?php echo $id2 ?>"> <?php echo $names ?></a></h3>
    ...
    <center>
    <a href="rok.php">
            <button type="button" id="more" class="btn btn-lg">More</button>
        </a>
    </center>
    <center>
    
    <div class="dropdown">
    <button id="drop" class="btn dropdown-toggle" type="button" data-toggle="dropdown">Category
    <span class="caret"></span></button>
    <ul class="dropdown-menu">
      <li><a href="userDress.php?nama = <?php echo $_SESSION['gender'] ?>">Dress</a></li>
      <li><a href="userTops.php?nama = <?php echo $_SESSION['gender'] ?>">Tops</a></li>
      <li><a href="userBottoms.php?nama = <?php echo $_SESSION['gender'] ?>">Bottoms</a></li>
      <li><a href="userBrooch.php?nama = <?php echo $_SESSION['gender'] ?>">Brooch</a></li>
      <li><a href="usePijamas.php?nama = <?php echo $_SESSION['gender'] ?>">Homedress & Pajamas</a></li>
    </ul>
  </div>
</div>
    </center>
...
.product-grid .product-content{background-color:white;text-align:center;padding:12px 0;margin:0 auto;position:absolute;left:0;right:0;bottom:-18px;z-index:1;transition:all .3s;}
