...
<input type="hidden" name="images" value="<?php echo $gambar1?>">
                        ...
                        <div class="action">
                            <input type="submit" class="title" name="cart1" value="add to cart">  
                            <input type="submit" class="title" name="book1" value="Booking">                       
        ...
        <div class="col-sm-2">
            ...
            <div class="product-grid">
                ...
                <div class="product-image">
                    ...
                    <h3 class="title1"><a href="userDetailTops.php?id= <?php echo $id2 ?>"> <?php echo $names ?></a></h3>
