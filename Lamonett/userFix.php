...
$sqlsss = "SELECT SUM(hargaP) AS sums FROM cart WHERE idP='$idP'";
...
let handleMainRequest = (req, res) => {
  axios({
    ...
    headers: {
      ...
      Authorization:
        "Basic " +
        Buffer.from("SB-Mid-server-lkn1pdoiEZZ688RQOkRcc1ab").toString("base64")
    },
    data:
      {
        transaction_details: {
...
<div id="header" class="navbar smart-scroll navbar-fixed-top">
  ...
  <br>
    ...
    <br>
    <div id="usrr">
        Total Amount : <?php echo "Rp. ".number_format($sum,0,",",".") ?>
    </div>
    <br>
    <br>
